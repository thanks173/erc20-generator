      ...
      <b-col>
        <b-card bg-variant="light" class="mb-4">
          ...
          <p class="font-weight-light">
            Create an ERC20 Token in less than a minute with the most used Smart
            Contract Generator for ERC20 Token. No login. No setup. No coding
            required.
          </p>
          <hr class="my-4" />
      ...
      <b-col>
          ...
          <div class="accordion mb-3" role="tablist">
            ...
            >
              <b-card-header role="tab">
                ...
                >
                  <span itemprop="name">
                    What's the difference between Fixed, Capped and Unlimited
                    Supply?
                  </span>
                </a>
              </b-card-header>
              ...
              >
                ...
                >
                  <span itemprop="text">
                    ...
                    generate more tokens than the defined supply cap.<br /><br />
              ...
              >
                ...
                >
                  <span itemprop="text">
                    ...
                    not actions that needs privileges. <br /><br />
                    <b>Ownable</b><br />
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> Who can mint or burn tokens? </span>
                </a>
              </b-card-header>
              <b-collapse
              ...
              >
                ...
                >
                  <span itemprop="text">
                    ...
                    you will be able to generate unlimited tokens.<br /><br />
                    <b>Burn</b><br />
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> Who can pause transfers? </span>
                </a>
              </b-card-header>
              <b-collapse
                id="who-can-pause"
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> What is ERC1363 Payable Token? </span>
                </a>
              </b-card-header>
              <b-collapse
                id="what-is-erc1363"
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> What is Token Recover? </span>
                </a>
              </b-card-header>
              <b-collapse
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> Where is my Token address? </span>
                </a>
              </b-card-header>
              <b-collapse
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> Who will be Token Owner? </span>
                </a>
              </b-card-header>
              <b-collapse
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> How to mint new tokens? </span>
                </a>
              </b-card-header>
              <b-collapse
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> Can I use my Token for ICO? </span>
                </a>
              </b-card-header>
              <b-collapse
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> Can my Token receive Ethereum? </span>
                </a>
              </b-card-header>
              <b-collapse
              ...
              >
                ...
                >
                  <span itemprop="text">
                    ...
                    thousands of tokens. It will be SCAM if you use as it. ERC20
                    Token Generator is FREE to use and there are about 10.000
                    tokens built on. Maybe someone used it to SCAM but it
                    doesn't mean you will use for it too. <b>YOU DON'T.</b>
        ...
        <h5 class="font-weight-light text-white">
          <a
            ...
            class="btn-block text-reset text-decoration-none"
          >
            <b-icon-caret-down-fill></b-icon-caret-down-fill> Ethereum
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> What is Ethereum? </span>
                </a>
              </b-card-header>
              <b-collapse
                id="what-is-ethereum"
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> What is a DApp? </span>
                </a>
              </b-card-header>
              <b-collapse
                id="what-is-a-dapp"
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> What is an ERC20 token? </span>
                </a>
              </b-card-header>
              <b-collapse
            ...
            >
              <b-card-header role="tab">
                <a
                  ...
                  class="btn-block text-reset text-decoration-none"
                >
                  <span itemprop="name"> What is a Multisig Wallet? </span>
                </a>
              </b-card-header>
              <b-collapse
                id="what-is-multisig"
    ...
    <b-row>
      <b-col>
        <b-alert show variant="warning" class="mt-4">
          ...
          <p>
            ERC20 Token Generator and its author are free of any liability
            regarding Tokens built using this App, and the use that is made of
            them. Tokens built on ERC20 Token Generator, their projects, their
            teams, their use of Token (as well as anything related to Token) are
            in no way connected to ERC20 Token Generator or its author.
          </p>
          <hr />
          <small>
            ERC20 Token Generator's code is provided under MIT License. Anyone
            can use it as per their needs. The App's purpose is to make people
            able to tokenize their ideas without coding or paying large amounts
            for it. Source code is public and well tested and continuously
            updated to reduce risk of bugs and introduce language optimizations.
            Anyway the purchase of tokens involves a high degree of risk. Before
            acquiring tokens, it is recommended to carefully weighs all the
