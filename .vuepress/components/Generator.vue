        ...
        <b-card v-if="!loading" bg-variant="transparent" border-variant="0">
          <b-alert show variant="danger" v-if="!metamask.installed">
            ...
            <p>
              ...
              <a href="https://metamask.io/" target="_blank">MetaMask</a>. Use
              any other wallet at your own risk.
            </p>
          </b-alert>
          ...
          >
            ...
            <div v-else>
              ...
              Transaction Hash:
              <a :href="trx.link" target="_blank"
                ><span v-html="trx.hash"></span></a
              ><br />
              <hr />
              ...
              <div v-else>
                ...
                <small class="text-muted"
                  >Supply: {{ token.initialBalance }} {{ token.symbol }}</small
                >
                <hr />
                <b-link
                  :href="token.link"
              ...
              <b-row>
                <b-col md="6" lg="4">
                  ...
                  >
                    ...
                    <ValidationProvider
                      v-if="token.supplyType !== 'Unlimited'"
                      name="token max supply"
                      :rules="{
                        required: true,
                        numeric: true,
                        min_value:
                          token.initialBalance > 0 ? token.initialBalance : 1,
                        max_value: 1000000000000000,
                      }"
                      v-slot="{ errors }"
                    >
                ...
                <b-col md="6" lg="4">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <option
                          v-for="n in ['Fixed', 'Unlimited', 'Capped']"
                          :value="n"
                        >
                          {{ n }}
                        </option>
                    ...
                    >
                      ...
                      >
                        <option
                          v-for="n in ['None', 'Ownable', 'Role Based']"
                          :value="n"
                        >
                          {{ n }}
                        </option>
                    ...
                    >
                      ...
                      >
                        <option
                          v-for="n in ['Unstoppable', 'Pausable']"
                          :value="n"
                        >
                          {{ n }}
                        </option>
                ...
                <b-col md="12" lg="4">
                  ...
                  >
                    ...
                    >
                      ...
                      <hr />
                      To deploy on Main Network you must select Main Ethereum
                      Network.
                    </b-alert>
                  </b-card>
                  <b-card
                  ...
                  >
                    <b-list-group flush class="payment-box">
                        ...
                        <span>
                          ...
                          <b-icon-info-circle
                            v-b-popover.v-warning.hover.top="
                              `Fee? I'll take no responsibility for your actions. ` +
                              'So no, enjoy this site without paying any fee.'
                            "
                          >
                          </b-icon-info-circle>
                        </span>
                      ...
                      <b-list-group-item class="d-flex justify-content-between">
                        ...
                        <b-badge variant="info"> Variable </b-badge>
                      </b-list-group-item>
                    </b-list-group>
                  </b-card>
                  <b-button
